  ...
  form.addEventListener('submit', function (e) {
    ...
    const texts = [
      ...
      },
      {
        ...
        code: `ADD SIPIPPAIR:TG=${TGnumber},TGN="${tgName}",ADDRTYPE=IPV4,IMN=1701,LSRVP=${uacLocalServerPort},OSU="${selectedSBC.sbcOSUIPforUAC}:${remoteOsuPort}",MSTYPE-=MASTER,DH=,DELTECH=YES,PTYPE=UDP,USEREMOTEP=YES;`
      },
      {
        title: '',
